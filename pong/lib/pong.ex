        ...
        {:tick, tick} ->
          case Game.move_ball(player1, player2, ball) do
            ...
            {:score, :player1, score, player1} ->
              broadcast(sessions, {:player1, :score, score + 1})
              :timer.send_after(@tick, self(), {:serve, player2})

            {:score, :player2, score, player2} ->
              broadcast(sessions, {:player2, :score, score + 1})
              :timer.send_after(@tick, self(), {:serve, player1})        
          end
